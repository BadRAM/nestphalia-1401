...
public static class Assets
{
    ...
    public static void Load()
    {
        ...
        Structures.Add(new DoorTemplate("door_strong","Vault Door", "", Resources.GetTextureByName("vault_door_closed"), Resources.GetTextureByName("vault_door_open"), 250, 500, 15, 5, 32));
        ...
        (
            ...
            (
                ...
                5,
                120,
                new ProjectileTemplate("tower_basic_bullet", Resources.GetTextureByName("bullet"), 15, 400), 
                0,
                40,
        ...
        (
            ...
            (
                ...
                5,
                100,
                new ProjectileTemplate("tower_machinegun_bullet", Resources.GetTextureByName("bullet"), 5, 400), 
                0,
                400,
        ...
        (
            ...
            (
                ...
                Double.MinValue, 
                4,
                new MortarShellTemplate("mine_armed", Resources.GetTextureByName("mine"), 20, 0.4, 0, 32),
                12,
                5
            )
        );
        ...
        (
            ...
            (
                ...
                5,
                90,
                new MortarShellTemplate("tower_mortar_shell", Resources.GetTextureByName("bullet"), 10, 0.7, 96, 48),
                0,
                30,
        ...
        (
            ...
            (
                ...
                5,
                120,
                new LightningBoltTemplate("tower_lightning_attack", 10), 
                46,
                400,
                TowerTemplate.TargetSelector.Random,
                false,
        ...
        (
            ...
            (
                ...
                5,
                450,
                new ProjectileTemplate("tower_sniper_bullet", Resources.GetTextureByName("bullet"), 60, 800), 
                0,
                25,
                TowerTemplate.TargetSelector.Random,
                true,
        ...
        (
            ...
            (
                "beacon_spawnboost",
                "Brood Stratagem",
                "Adjacent nests send an extra wave of bugs \nto the target location",
                Resources.GetTextureByName("flag2"),
                100,
                2000,
                9,
        ...
        (
            ...
            (
                ...
                (
                    "minion_grasshopper",
                    "Grasshopper",
                    "\nHoppers are renowned for their short \ntemper, and musical talent",
