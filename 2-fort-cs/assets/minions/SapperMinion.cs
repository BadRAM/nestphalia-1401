...
public class SapperMinionTemplate : MinionTemplate
{
    ...
    public SapperMinionTemplate(string name, Texture attackingTexture, Texture retreatingTexture, double maxHealth, double armor, ProjectileTemplate projectile, double range, double rateOfFire, double speed, bool isFlying, float physicsRadius) : base(name, attackingTexture, maxHealth, armor, projectile, range, rateOfFire, speed, isFlying, physicsRadius)
    {
